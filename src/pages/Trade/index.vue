<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="(address, index) in addressList">
        <span class="username" :class="{selected: address.isDefault === '1'}">{{ address.consignee }}</span>
        <p @click="updateDefaultAddress(index)">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="tradeDetail in orderTradeInfo.detailArrayList">
          <li>
    ...
    <div class="money clearFix">
      <ul>
        <li>
          <b><i>{{ orderTradeInfo.totalNum }}</i>件商品，总商品金额</b>
          <span>¥{{ orderTradeInfo.totalAmount }}</span>
        </li>
        <li>
          <b>返现：</b>
          <span>0.00</span>
    ...
    <div class="trade">
      <div class="price">应付金额:　<span>¥{{ orderTradeInfo.totalAmount }}</span></div>
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      orderTradeInfo: state => state.order.orderTradInfo
    }),
    defaultAddress() {
