    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            <li class="with-x" v-show="searchObj.categoryName">
              ...
              <li class="yui3-u-1-5" v-for="good in goodsList" :key="good.id">
                <div class="list-wrap">
                  ...
                  <div class="price">
                    <strong>
                      <em>¥</em>
                      <i style="padding-left: 10px">{{ good.price }}</i>
                    </strong>
                  </div>
                  <div class="attr">
...
export default {
  name: 'Search',
  beforeMount() {
    Object.assign(this.searchObj, this.$route.query)
  },
  mounted() {
    this.fetchData();
  },
  ...
  watch: {
    $route() {
      this.searchObj.category1Id = undefined;
      this.searchObj.category2Id = undefined;
      this.searchObj.category3Id = undefined;
      Object.assign(this.searchObj, this.$route.query)
      this.fetchData();
    }
  }
