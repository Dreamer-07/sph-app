  ...
  <div class="pay-main">
    <div class="pay-container">
      ...
      <div class="checkout-steps">
        ...
        <div class="submit">
          <a class="btn" @click="openWxPay">立即支付</a>
        </div>
        <div class="otherpay">
          <div class="step-tit">
            <h5>其他支付方式</h5>
...
export default {
  ...
  methods: {
    // 加载支付信息
    async fetchData() {
      let result = await this.$api.payment.getPayInfo(this.$route.query.orderId);
      if (result.code === 200) {
    ...
    async openWxPay() {
      ...
      // 配置弹出框
      this.$alert(`<img src="${url}" alt=""/>`, '巴御前天下第一', {
        center: true,
        showClose: false,
