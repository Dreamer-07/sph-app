<template>
  <div class="detail">
    ...
    <section class="con">
      <!-- 导航路径区域 -->
      <div class="conPoin">
        <span v-show="detailCategoryView.category1Name">{{ detailCategoryView.category1Name }}</span>
        <span v-show="detailCategoryView.category2Name">{{ detailCategoryView.category2Name }}</span>
        <span v-show="detailCategoryView.category3Name">{{ detailCategoryView.category3Name }}</span>
      </div>
      <!-- 主要内容区域 -->
      <div class="mainCon">
        <!-- 左侧放大镜区域 -->
        <div class="previewWrap">
          <!--放大镜效果-->
          <Zoom :imageList="detailSkuInfo.skuImageList"/>
          <!-- 小图列表 -->
          <ImageList :imageList="detailSkuInfo.skuImageList"/>
        </div>
        <!-- 右侧选择区域布局 -->
        <div class="InfoWrap">
          <div class="goodsDetail">
            <h3 class="InfoName">{{ detailSkuInfo.skuName }}</h3>
            <p class="news">{{ detailSkuInfo.skuDesc }}</p>
            <div class="priceArea">
              <div class="priceArea1">
                <div class="title">价&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;格</div>
                <div class="price">
                  <i>¥</i>
                  <em>{{ detailSkuInfo.price }}</em>
                  <span>降价通知</span>
                </div>
                <div class="remark">
                  <i>累计评价</i>
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in detailSpuSaleAttrList" :key="spuSaleAttr.id">
                <dt class="title">{{ spuSaleAttr.saleAttrName }}</dt>
                <dd changepirce="0" v-for="(spuSaleAttrValue, index) in spuSaleAttr.spuSaleAttrValueList"
                    :class="{active: spuSaleAttrValue.isChecked == 1}"
                    @click="changeActiveSpuSaleAttr(spuSaleAttr.spuSaleAttrValueList, index)"
                >
...
<script>
import ImageList from './Childrens/ImageList'
import Zoom from './Childrens/Zoom'
