  ...
  <div class="order-right">
    <div class="order-content">
      ...
      <div class="orders">
        ...
        <table class="order-item" v-for="order in orderListInfo.records">
          <thead>
          <tr>
            <th colspan="5">
          ...
          <tr v-for="(orderDetail, index) in order.orderDetailList">
            ...
            <td :rowspan="order.orderDetailList.length" v-if="index === 0" width="8%" class="center">{{ order.consignee || '巴御前天下第一' }}</td>
      ...
      <div class="choose-order">
        <Pagination :page-no="pageNo" :page-size="pageSize" :continuity="7" :total="orderListInfo.total" @updatePageNo="updatePageNo"/>
      </div>
    </div>
    <!--猜你喜欢-->
    <div class="like">
...
export default {
  ...
  methods: {
    ...
    async fetchData() {
      ...
      let result = await this.$api.order.getOrderList(pageNo, pageSize);
      if (result.code === 200) {
        this.orderListInfo = result.data;
      } else {
